## Context
The goal is to evolve Penpot’s design system so it can support backend/admin-style screens more effectively, while keeping the implementation aligned with Penpot’s existing Rum + schema + SCSS conventions and leaving clean integration points for upcoming AI features. The current working tree already has a first batch of admin-oriented DS primitives (`admin_page`, `page_header`, `filter_bar`, `data_table`, `pagination`, `confirm_dialog`), but they are still minimal. The right next step is not to add many unrelated widgets; it is to harden those primitives, prove them on one real admin screen, and then layer AI-specific UI and backend orchestration onto the same page patterns.
...
- Typography primitives: `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/foundations/typography/heading.cljs`, `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/foundations/typography/text.cljs`
- Input composition: `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/controls/input.cljs`, `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/controls/utilities/input_field.cljs`
- Accessible selection patterns: `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/controls/select.cljs`, `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/controls/combobox.cljs`
- Existing tabs: `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/layout/tab_switcher.cljs`
- Existing feedback/loading/empty states: `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/product/empty_state.cljs`, `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/product/loader.cljs`, `/Users/jiangjuping/Desktop/gree/penpot/frontend/src/app/main/ui/ds/notifications/toast.cljs`
...
- `data-table*`: upgrade from simple div rows to an accessible native table structure, then add sortable columns, row click hooks, selection state, and empty/loading captions only when the first real screen requires them.
...
Before creating more DS pieces like cards, badges, bulk action bars, or advanced filters, build/refactor one actual admin page with this composition:
- `admin-page*`
- `page-header*`
- `filter-bar*`
- `data-table*`
...
- Use backend-enforced feature checks, not hidden UI alone. The current AI RPC already does this through `ensure-ai-enabled!` in `/Users/jiangjuping/Desktop/gree/penpot/backend/src/app/rpc/commands/ai.clj:18`.
...
- AI features plug into the same page patterns through `frontend/src/app/main/data/ai.cljs` and existing backend AI RPC/task infrastructure, without needing a second UI system.
